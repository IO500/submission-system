    ...
    <div class="table-responsive">
        <table class="tb">
            ...
            <tbody>
                ...
                <tr>
                    <td class="tb-id"><?php echo $this->Number->format($s->id) ?></td>
                    <td><?php echo h($s->name) ?></td>
                    <td class="tb-actions">
                        <?php echo $this->AuthLink->link('<i class="fas fa-highlighter"></i>', ['action' => 'edit', $s->id], ['escape' => false]) ?>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
