...
class ListingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'release_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'type_id' => ['type' => 'unique', 'columns' => ['type_id', 'release_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
