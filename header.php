<nav>
    <div class="container navigation">
        <div class="logo">
            <a href="<?php echo $this->Url->build('/') ?>">IO500<span>HUB</span></a>
            <strong style="display: block; font-size: 10px; color: #d63b1e">[ TESTING ENVIRONMENT ]</strong>
            <?php echo strtoupper($this->getRequest()->getSession()->read('Auth.role')); ?> ACCESS
        </div>
